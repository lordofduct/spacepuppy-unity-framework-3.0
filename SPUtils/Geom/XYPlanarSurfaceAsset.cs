...
namespace com.spacepuppy.Geom
{
    ...
    [CreateAssetMenu(fileName = "XYPlanarSurface", menuName = "Spacepuppy/Surfaces/XY Planar Surface")]
    public class XYPlanarSurfaceAsset : ScriptableObject, IPlanarSurface
    {
