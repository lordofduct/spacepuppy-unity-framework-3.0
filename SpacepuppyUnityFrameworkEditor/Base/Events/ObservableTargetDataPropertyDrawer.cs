...
namespace com.spacepuppyeditor.Base.Events
{
    ...
    public class ObservableTargetDataPropertyDrawer : PropertyDrawer
    {
        ...
        public bool GetPropertyIsComplex(SerializedProperty property)
        {
            ...
            return triggerProp.objectReferenceValue != null && triggerProp.objectReferenceValue is IObservableTrigger && (triggerProp.objectReferenceValue as IObservableTrigger).GetEvents().Length > 0;
        }
        ...
        private class CustomComponentChoiceSelector : DefaultComponentChoiceSelector, IComponentChoiceSelector
        {
            ...
            protected override void OnBeforeGUI()
            {
                ...
                for (int i = 0; i < this.Components.Length; i++)
                {
                    ...
                    {
                        var arr = (c as IObservableTrigger).GetEvents();
                        if (arr.Length == 1)
                        {
